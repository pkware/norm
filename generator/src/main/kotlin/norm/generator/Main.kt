 ...
 *   [JdbcAnalyzer.fetchReservedWords] — used when resolving a CTE-wrapped result column's
 *   provenance (see [resolveCteOutputExpression]'s own `reservedWords` parameter doc). Required
