...
public class PostgresQueries(
  ...
  private fun <T : Any, Return> all(mapper: (
    ...
    val rowReader: ResultSet.() -> T = {
      mapper(
        ...
        getString(40),
        getString(41),
        getArray(42)?.mapElements { getString(2) },
        getString(43),
        getString(44),
        getString(45),
        getString(46),
        getString(47),
        getString(48),
        getObject(49, LocalDate::class.java),
        getObject(50, LocalDate::class.java),
        getObject(51, LocalDate::class.java),
        getObject(52, LocalTime::class.java),
        getObject(53, LocalTime::class.java),
        getObject(54, LocalTime::class.java),
        getObject(55, OffsetTime::class.java),
        getObject(56, OffsetTime::class.java),
        getObject(57, OffsetTime::class.java),
        getObject(58, LocalDateTime::class.java),
        getObject(59, LocalDateTime::class.java),
        getObject(60, LocalDateTime::class.java),
        getObject(61, OffsetDateTime::class.java)?.toInstant(),
        getObject(62, OffsetDateTime::class.java).toInstant(),
        getObject(63, OffsetDateTime::class.java)?.toInstant(),
        getObject(64, UUID::class.java),
        getObject(65, UUID::class.java),
        getObject(66, UUID::class.java),
        getBytes(67),
        getBytes(68),
        getBytes(69),
        getArray(70)?.mapElements { getInt(2).takeUnless { wasNull() } },
        getArray(71).mapElements { getInt(2).takeUnless { wasNull() } },
        getArray(72)?.mapElements { getString(2) },
        getArray(73).mapElements { getString(2) },
        getArray(74)?.mapElements { getShort(2).takeUnless { wasNull() } },
        getArray(75).mapElements { getShort(2).takeUnless { wasNull() } },
        getArray(76)?.mapElements { getLong(2).takeUnless { wasNull() } },
        getArray(77).mapElements { getLong(2).takeUnless { wasNull() } },
        getArray(78)?.mapElements { getFloat(2).takeUnless { wasNull() } },
        getArray(79).mapElements { getFloat(2).takeUnless { wasNull() } },
        getArray(80)?.mapElements { getDouble(2).takeUnless { wasNull() } },
        getArray(81).mapElements { getDouble(2).takeUnless { wasNull() } },
        getArray(82)?.mapElements { getBigDecimal(2) },
        getArray(83).mapElements { getBigDecimal(2) },
        getArray(84)?.mapElements { getBoolean(2).takeUnless { wasNull() } },
        getArray(85).mapElements { getBoolean(2).takeUnless { wasNull() } },
        getArray(86)?.mapElements { getString(2) },
        getArray(87).mapElements { getString(2) },
        getArray(88)?.mapElements { getString(2) },
        getArray(89).mapElements { getString(2) },
        getArray(90)?.mapElements { getBytes(2) },
        getArray(91).mapElements { getBytes(2) },
        getArray(92)?.mapElements { getObject(2, UUID::class.java) },
        getArray(93).mapElements { getObject(2, UUID::class.java) },
        getArray(94)?.mapElements { getObject(2, LocalDate::class.java) },
        getArray(95).mapElements { getObject(2, LocalDate::class.java) },
        getArray(96)?.mapElements { getObject(2, LocalTime::class.java) },
        getArray(97).mapElements { getObject(2, LocalTime::class.java) },
        getArray(98)?.mapElements { getObject(2, OffsetTime::class.java) },
        getArray(99).mapElements { getObject(2, OffsetTime::class.java) },
        getArray(100)?.mapElements { getObject(2, LocalDateTime::class.java) },
        getArray(101).mapElements { getObject(2, LocalDateTime::class.java) },
        getArray(102)?.mapElements { getObject(2, OffsetDateTime::class.java)?.toInstant() },
        getArray(103).mapElements { getObject(2, OffsetDateTime::class.java)?.toInstant() },
        getArray(104)?.mapElements { getLong(2).takeUnless { wasNull() } },
        getArray(105).mapElements { getLong(2).takeUnless { wasNull() } },
      )
    }
  ...
  @Throws(SQLException::class)
  override fun <T : Any> selectSystemColumns(string_type: String, mapper: (
    xmin: String,
    xmax: String,
    ctid: String,
  ) -> T): T {
    val sql = "SELECT xmin, xmax, ctid FROM type WHERE string_type = ?"
    val rowReader: ResultSet.() -> T = {
      mapper(
        getString(1),
        getString(2),
  ...
  @Throws(SQLException::class)
  override fun updateTransactionIdentifiers(
    xid_type: String?,
    xid_notnull_type: String,
    xid8_type: String?,
    xid8_notnull_type: String,
    ...
    val sql = """
        ...
        """.trimMargin()
    return driver.executeRows(sql) {
      setObject(1, xid_type, Types.OTHER)
      setObject(2, xid_notnull_type, Types.OTHER)
      setObject(3, xid8_type, Types.OTHER)
      setObject(4, xid8_notnull_type, Types.OTHER)
      setObject(5, tid_type, Types.OTHER)
      setObject(6, tid_notnull_type, Types.OTHER)
      setObject(7, cid_type, Types.OTHER)
      setObject(8, cid_notnull_type, Types.OTHER)
      setString(9, string_type)
    }
  }

  @Throws(SQLException::class)
  override fun <Input : Any> updateTransactionIdentifiers(
    stream: Iterable<Input>,
    ...
    return driver.execute(sql) {
      ...
      val results = mutableListOf<IntArray>()
      for (entry in stream) {
        setObject(1, xid_type(entry), Types.OTHER)
        setObject(2, xid_notnull_type(entry), Types.OTHER)
        setObject(3, xid8_type(entry), Types.OTHER)
        setObject(4, xid8_notnull_type(entry), Types.OTHER)
        setObject(5, tid_type(entry), Types.OTHER)
        setObject(6, tid_notnull_type(entry), Types.OTHER)
        setObject(7, cid_type(entry), Types.OTHER)
        setObject(8, cid_notnull_type(entry), Types.OTHER)
