CREATE TABLE type (
  ...
  blob_type oid,
  xid_type xid,
  xid_notnull_type xid NOT NULL DEFAULT '0',
  xid8_type xid8,
  xid8_notnull_type xid8 NOT NULL DEFAULT '0',
  tid_type tid,
  tid_notnull_type tid NOT NULL DEFAULT '(0,0)',
  cid_type cid,
  cid_notnull_type cid NOT NULL DEFAULT '0',
  xid_array_type xid[],
  text_type text,
  ...
  int2_array_notnull_type int2[] NOT NULL DEFAULT '{}',
  int8_array_type int8[],
  int8_array_notnull_type int8[] NOT NULL DEFAULT '{}',
  float4_array_type float4[],
  float4_array_notnull_type float4[] NOT NULL DEFAULT '{}',
  float8_array_type float8[],
  float8_array_notnull_type float8[] NOT NULL DEFAULT '{}',
  numeric_array_type numeric[],
  numeric_array_notnull_type numeric[] NOT NULL DEFAULT '{}',
  bool_array_type bool[],
  bool_array_notnull_type bool[] NOT NULL DEFAULT '{}',
  json_array_type json[],
  json_array_notnull_type json[] NOT NULL DEFAULT '{}',
  jsonb_array_type jsonb[],
  jsonb_array_notnull_type jsonb[] NOT NULL DEFAULT '{}',
  bytea_array_type bytea[],
  bytea_array_notnull_type bytea[] NOT NULL DEFAULT '{}',
  uuid_array_type uuid[],
  uuid_array_notnull_type uuid[] NOT NULL DEFAULT '{}',
  date_array_type date[],
  date_array_notnull_type date[] NOT NULL DEFAULT '{}',
  time_array_type time[],
  time_array_notnull_type time[] NOT NULL DEFAULT '{}',
  timetz_array_type timetz[],
  timetz_array_notnull_type timetz[] NOT NULL DEFAULT '{}',
